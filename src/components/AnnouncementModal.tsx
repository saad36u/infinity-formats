...
export default function AnnouncementModal({
  ...
  return (
    ...
    >
      <div 
        className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-2xl sm:rounded-3xl bg-main border-2 border-[#8B1538]/50 shadow-2xl"
      ...
      >
        ...
        <div className="p-5 sm:p-7 pt-8 sm:pt-10">
          ...
          <div className="flex flex-col items-center text-center mb-5 sm:mb-6">
            ...
            <h2 className="text-xl sm:text-2xl font-black text-main mb-2">
          ...
          <div className="space-y-3 sm:space-y-4 text-sm sm:text-base leading-relaxed">
            <p className="text-center font-semibold text-main">
            ...
            <div className="bg-gradient-to-l from-[#8B1538]/10 to-[#D4AF37]/15 dark:from-[#8B1538]/30 dark:to-[#D4AF37]/20 border-2 border-[#8B1538]/30 dark:border-[#D4AF37]/40 rounded-xl p-4 my-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base text-main leading-relaxed font-semibold">
            ...
            <button
              onClick={handleClose}
              className="w-full text-subtle hover:text-[#8B1538] dark:hover:text-[#D4AF37] text-sm py-2 transition-colors font-semibold"
            >
              تصفح الموقع أولاً ←
            </button>
          </div>

          <div className="mt-5 pt-4 border-t border-main text-center">
            <p className="text-[10px] sm:text-xs text-subtle font-medium">
