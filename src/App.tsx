...
function TestimonialsSection() {
  ...
  return (
    <>
      ...
      >
        <div className="relative">
          ...
          <div className="glass-strong rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-2xl min-h-[260px] sm:min-h-[280px] flex flex-col">
            <div className="flex items-center justify-between gap-3 pb-4 mb-4 border-b border-main">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  <h4 className="font-bold text-sm sm:text-base truncate text-main">{current.name}</h4>
            ...
            <div className="flex-1 flex items-center">
              <p className="text-sm sm:text-base md:text-lg text-main leading-relaxed text-right w-full">
                {current.text}
              </p>
            </div>
          </div>
        ...
        {/* شريط التقدم + العدّاد */}
        <div className="mt-6">
          <div className="flex items-center justify-between text-xs sm:text-sm text-muted mb-2">
        ...
        <div className="flex justify-center mt-6">
          <button
            ...
            className="group glass-strong border-2 border-[#D4AF37]/50 hover:border-[#D4AF37] px-6 py-3 rounded-full text-sm sm:text-base font-bold flex items-center gap-2 transition-all duration-300 hover:scale-105 shadow-xl text-main"
          >
      ...
      {/* ====== نافذة عرض كل الآراء ====== */}
      {showAll && (
        <div className="fixed inset-0 z-[100] bg-overlay-modal backdrop-blur-md">
          <div className="h-full flex flex-col">
            <div className="flex items-center justify-between px-4 sm:px-6 py-4 border-b border-main bg-overlay-modal-header backdrop-blur-lg sticky top-0 z-10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl font-black text-main">كل آراء العملاء</h3>
                  <p className="text-xs text-subtle">{total} رأي من عملائنا الكرام</p>
                </div>
              </div>
              <button
            ...
            <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 max-w-7xl mx-auto">
                {testimonialsData.map((t) => (
                  <div 
                    key={t.id} 
                    className="glass-strong rounded-xl p-4 border-2 border-glass hover:border-[#D4AF37]/60 transition-all hover:scale-[1.02] shadow-lg"
                  >
                    <div className="flex items-start justify-between gap-2 mb-3">
                      <div className="flex items-center gap-2 min-w-0 flex-1">
                        ...
                        <div className="min-w-0 flex-1">
                          <h4 className="font-bold text-sm truncate text-main">{t.name}</h4>
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-main text-main overflow-x-hidden transition-colors duration-500">
        ...
        <nav className="container mx-auto px-3 sm:px-4 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                <h1 className="text-base sm:text-xl font-bold text-main">شركة إنفينتي</h1>
                <p className="text-[10px] sm:text-xs text-[#8B1538] dark:text-[#D4AF37] font-semibold">لتنسيقات السفر</p>
              </div>
            </div>

            <div className="hidden lg:flex items-center gap-8">
              <button onClick={() => scrollToSection('home')} className="text-sm text-main hover:text-[#8B1538] dark:hover:text-[#D4AF37] transition-colors font-medium">الرئيسية</button>
              <button onClick={() => scrollToSection('services')} className="text-sm text-main hover:text-[#8B1538] dark:hover:text-[#D4AF37] transition-colors font-medium">خدماتنا</button>
              <button onClick={() => scrollToSection('testimonials')} className="text-sm text-main hover:text-[#8B1538] dark:hover:text-[#D4AF37] transition-colors font-medium">آراء العملاء</button>
              <button onClick={() => scrollToSection('requirements')} className="text-sm text-main hover:text-[#8B1538] dark:hover:text-[#D4AF37] transition-colors font-medium">الشروط والخطوات</button>
              <button onClick={() => scrollToSection('contact')} className="text-sm text-main hover:text-[#8B1538] dark:hover:text-[#D4AF37] transition-colors font-medium">تواصل معنا</button>
            </div>
      ...
      <section id="home" className="relative min-h-[100svh] flex items-center justify-center pt-24 pb-12 sm:pt-20 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-edge via-transparent via-40% to-edge"></div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-white/80 dark:bg-white/10 backdrop-blur-md px-4 sm:px-6 py-2 sm:py-3 rounded-full mb-6 sm:mb-8 border border-[#8B1538]/30 shadow-lg">
              ...
              <span className="text-xs sm:text-sm text-main font-semibold">خدمة موثوقة ومعتمدة منذ سنوات</span>
            </div>
            ...
            <div className="bg-white/85 dark:bg-transparent backdrop-blur-md rounded-2xl p-4 sm:p-6 mb-3 sm:mb-4 shadow-xl dark:shadow-none border border-white/50 dark:border-transparent">
              <h1 className="text-3xl sm:text-5xl md:text-7xl font-black leading-tight text-main">
            ...
            <div className="bg-white/85 dark:bg-transparent backdrop-blur-md rounded-xl p-4 sm:p-6 max-w-3xl mx-auto shadow-lg dark:shadow-none mb-6 sm:mb-8 border border-white/50 dark:border-transparent">
              <p className="text-sm sm:text-lg md:text-xl text-muted leading-relaxed font-semibold">
      ...
      <section className="py-16 sm:py-20 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-overlay-light"></div>
        <div className="absolute inset-0 bg-gradient-to-b from-edge via-transparent via-50% to-edge"></div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12 sm:mb-16">
            <div className="bg-white/85 dark:bg-transparent backdrop-blur-md rounded-2xl px-6 py-3 inline-block shadow-lg dark:shadow-none border border-white/50 dark:border-transparent">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-main">
                أثر يمكن قياسه
              </h2>
            </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
            <div className="glass-strong p-4 sm:p-8 rounded-2xl hover:scale-105 transition-all duration-300 group text-center shadow-xl border-2 border-glass">
              ...
              <p className="text-xs sm:text-base text-muted font-semibold">حالات تم تنسيقها بنجاح</p>
            </div>
            ...
            <div className="glass-strong p-4 sm:p-8 rounded-2xl hover:scale-105 transition-all duration-300 group text-center shadow-xl border-2 border-glass">
              ...
              <p className="text-xs sm:text-base text-muted font-semibold">شفافية ومتابعة مستمرة</p>
            </div>
            ...
            <div className="glass-strong p-4 sm:p-8 rounded-2xl hover:scale-105 transition-all duration-300 group text-center shadow-xl border-2 border-glass">
              ...
              <p className="text-xs sm:text-base text-muted font-semibold">سرعة في الإنجاز</p>
            </div>
            ...
            <div className="glass-strong p-4 sm:p-8 rounded-2xl hover:scale-105 transition-all duration-300 group text-center shadow-xl border-2 border-glass">
              ...
              <p className="text-xs sm:text-base text-muted font-semibold">دعم الحالات الإنسانية</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <div className="bg-white/85 dark:bg-transparent backdrop-blur-md rounded-xl px-6 py-3 max-w-2xl mx-auto shadow-lg dark:shadow-none border border-white/50 dark:border-transparent">
              <p className="text-sm sm:text-lg text-muted font-semibold">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 max-w-6xl mx-auto">
            <div className="glass-strong p-5 sm:p-8 rounded-2xl relative overflow-hidden group hover:scale-105 transition-all duration-300 shadow-xl border-2 border-glass">
              ...
              <div className="relative">
                ...
                <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-main">مراجعة الطلب</h3>
            ...
            <div className="glass-strong p-5 sm:p-8 rounded-2xl relative overflow-hidden group hover:scale-105 transition-all duration-300 shadow-xl border-2 border-glass">
              ...
              <div className="relative">
                ...
                <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-main">تنسيق المعبر</h3>
                <p className="text-xs sm:text-sm text-muted leading-relaxed">
            ...
            <div className="glass-strong p-5 sm:p-8 rounded-2xl relative overflow-hidden group hover:scale-105 transition-all duration-300 shadow-xl border-2 border-glass">
              ...
              <div className="relative">
                ...
                <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-main">إتمام الإجراءات</h3>
                <p className="text-xs sm:text-sm text-muted leading-relaxed">
            ...
            <div className="glass-strong p-5 sm:p-8 rounded-2xl relative overflow-hidden group hover:scale-105 transition-all duration-300 shadow-xl border-2 border-glass">
              ...
              <div className="relative">
                ...
                <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-main">متابعة الخروج</h3>
                <p className="text-xs sm:text-sm text-muted leading-relaxed">
          ...
          <div className="mt-12 sm:mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 max-w-6xl mx-auto">
            <div className="glass-strong p-5 sm:p-6 rounded-xl border-2 border-glass hover:border-[#8B1538] transition-all shadow-xl">
              <Shield className="w-8 h-8 sm:w-10 sm:h-10 text-[#8B1538] dark:text-[#D4AF37] mb-3 sm:mb-4" />
              <h4 className="text-base sm:text-lg font-bold mb-2 text-main">أمان وخصوصية</h4>
              <p className="text-xs sm:text-sm text-muted leading-relaxed">
            ...
            <div className="glass-strong p-5 sm:p-6 rounded-xl border-2 border-glass hover:border-[#8B1538] transition-all shadow-xl">
              ...
              <h4 className="text-base sm:text-lg font-bold mb-2 text-main">معاملات آمنة</h4>
              <p className="text-xs sm:text-sm text-muted leading-relaxed">
            ...
            <div className="glass-strong p-5 sm:p-6 rounded-xl border-2 border-glass hover:border-[#8B1538] transition-all shadow-xl">
              ...
              <h4 className="text-base sm:text-lg font-bold mb-2 text-main">وثائق كاملة</h4>
              <p className="text-xs sm:text-sm text-muted leading-relaxed">
            ...
            <div className="glass-strong p-5 sm:p-6 rounded-xl border-2 border-[#D4AF37]/50 hover:border-[#D4AF37] transition-all bg-gradient-to-br from-[#D4AF37]/10 to-transparent shadow-xl">
              ...
              <h4 className="text-base sm:text-lg font-bold mb-2 text-main">استرداد آمن وسريع</h4>
              <p className="text-xs sm:text-sm text-muted leading-relaxed">
      ...
      <section id="requirements" className="py-16 sm:py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="glass-strong p-5 sm:p-8 md:p-12 rounded-3xl shadow-2xl border-2 border-glass">
              <div className="grid md:grid-cols-2 gap-8 sm:gap-10">
                <div>
                  <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 flex items-center gap-3 text-main">
                  ...
                  <ul className="space-y-3 sm:space-y-4">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-sm sm:text-base text-main font-medium">صورة واضحة من جواز السفر (ساري المفعول)</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-[#8B1538] dark:text-[#D4AF37] mt-1 flex-shrink-0" />
                      <span className="text-sm sm:text-base text-main font-medium">صورة شخصية حديثة بخلفية بيضاء</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-[#8B1538] dark:text-[#D4AF37] mt-1 flex-shrink-0" />
                      <span className="text-sm sm:text-base text-main font-medium">صورة من بطاقة الهوية الشخصية</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-[#8B1538] dark:text-[#D4AF37] mt-1 flex-shrink-0" />
                      <span className="text-sm sm:text-base text-main font-medium">معلومات الاتصال الكاملة (هاتف، عنوان)</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-[#8B1538] dark:text-[#D4AF37] mt-1 flex-shrink-0" />
                      <span className="text-sm sm:text-base text-main font-medium">وثائق إضافية حسب نوع الحالة (إن وجدت)</span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-3 sm:space-y-4">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-sm sm:text-base text-main font-medium">سرية تامة لجميع المعلومات والبيانات</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Star className="w-4 h-4 sm:w-5 sm:h-5 text-[#D4AF37] mt-1 flex-shrink-0 fill-[#D4AF37]" />
                      <span className="text-sm sm:text-base text-main font-medium">متابعة مستمرة وتحديثات لحظية</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Star className="w-4 h-4 sm:w-5 sm:h-5 text-[#D4AF37] mt-1 flex-shrink-0 fill-[#D4AF37]" />
                      <span className="text-sm sm:text-base text-main font-medium">شفافية كاملة في جميع الإجراءات</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Star className="w-4 h-4 sm:w-5 sm:h-5 text-[#D4AF37] mt-1 flex-shrink-0 fill-[#D4AF37]" />
                      <span className="text-sm sm:text-base text-main font-medium">استرداد آمن للأموال خلال 24 ساعة عند الإلغاء</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Star className="w-4 h-4 sm:w-5 sm:h-5 text-[#D4AF37] mt-1 flex-shrink-0 fill-[#D4AF37]" />
                      <span className="text-sm sm:text-base text-main font-medium">دعم فني متواصل على مدار الساعة</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="mt-8 sm:mt-12 p-5 sm:p-6 bg-gradient-to-l from-[#8B1538]/15 to-[#D4AF37]/15 rounded-2xl border-2 border-[#8B1538]/20 dark:border-[#D4AF37]/30">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h4 className="text-lg sm:text-xl font-bold mb-2 text-main">سياسة الخصوصية والأمان</h4>
      ...
      <section id="testimonials" className="py-16 sm:py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="mt-12 sm:mt-16 max-w-4xl mx-auto">
            <div className="glass-strong p-5 sm:p-8 rounded-2xl text-center shadow-2xl border-2 border-glass">
              <h3 className="text-xl sm:text-2xl font-bold mb-5 sm:mb-6 text-main">لماذا يثق بنا عملاؤنا؟</h3>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 sm:gap-6">
                <div className="flex flex-col items-center">
                  ...
                  <p className="font-semibold text-sm sm:text-base text-main">ضمان وأمان</p>
                </div>
                <div className="flex flex-col items-center">
                  ...
                  <p className="font-semibold text-sm sm:text-base text-main">سرعة الإنجاز</p>
                </div>
                <div className="flex flex-col items-center">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-[#8B1538] to-[#6B0F1A] rounded-full flex items-center justify-center mb-3 glow-burgundy text-white">
                    <Heart className="w-7 h-7 sm:w-8 sm:h-8" />
                  </div>
                  <p className="font-semibold text-sm sm:text-base text-main">دعم إنساني</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group glass-strong p-5 sm:p-8 rounded-2xl hover:scale-105 transition-all duration-300 border-2 border-glass hover:border-[#25D366] relative overflow-hidden shadow-2xl"
              >
                ...
                <div className="relative">
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold mb-3 text-center text-main">واتساب</h3>
                  <p className="text-sm sm:text-base text-muted text-center mb-5 sm:mb-6">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group glass-strong p-5 sm:p-8 rounded-2xl hover:scale-105 transition-all duration-300 border-2 border-glass hover:border-[#0088cc] relative overflow-hidden shadow-2xl"
              >
                ...
                <div className="relative">
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold mb-3 text-center text-main">تيليجرام</h3>
                  <p className="text-sm sm:text-base text-muted text-center mb-5 sm:mb-6">
            ...
            <div className="mt-8 sm:mt-12 glass-strong p-5 sm:p-8 rounded-2xl shadow-2xl border-2 border-glass">
              <h3 className="text-xl sm:text-2xl font-bold mb-5 sm:mb-6 text-center text-main">معلومات التواصل الإضافية</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6 max-w-2xl mx-auto">
                <div className="flex flex-col items-center text-center p-4">
                  ...
                  <h4 className="font-bold mb-2 text-sm sm:text-base text-main">الهاتف</h4>
                  <p className="text-muted text-xs sm:text-sm font-semibold" dir="ltr">+972 56 770 6668</p>
                </div>
                ...
                <div className="flex flex-col items-center text-center p-4">
                  ...
                  <h4 className="font-bold mb-2 text-sm sm:text-base text-main">الموقع</h4>
                  <p className="text-muted text-xs sm:text-sm font-semibold">قطاع غزة، فلسطين</p>
                </div>
              </div>
            </div>
      ...
      {/* ========== FOOTER ========== */}
      <footer className="relative border-t border-main py-10 sm:py-12 bg-footer transition-colors duration-500">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div className="text-center md:text-right">
              <div className="flex items-center gap-3 mb-4 justify-center md:justify-start">
                ...
                <div>
                  <h3 className="text-lg font-bold text-main">شركة إنفينتي</h3>
            ...
            <div className="text-center md:text-right">
              <h4 className="font-bold mb-4 text-main">روابط سريعة</h4>
              <ul className="space-y-2">
                <li>
                  <button onClick={() => scrollToSection('home')} className="text-muted hover:text-[#8B1538] dark:hover:text-[#D4AF37] transition-colors text-sm font-medium">
                    الرئيسية
                  </button>
                </li>
                <li>
                  <button onClick={() => scrollToSection('services')} className="text-muted hover:text-[#8B1538] dark:hover:text-[#D4AF37] transition-colors text-sm font-medium">
                    خدماتنا
                  </button>
                </li>
                <li>
                  <button onClick={() => scrollToSection('testimonials')} className="text-muted hover:text-[#8B1538] dark:hover:text-[#D4AF37] transition-colors text-sm font-medium">
                    آراء العملاء
                  </button>
                </li>
                <li>
                  <button onClick={() => scrollToSection('contact')} className="text-muted hover:text-[#8B1538] dark:hover:text-[#D4AF37] transition-colors text-sm font-medium">
                    تواصل معنا
                  </button>
                </li>
              </ul>
            ...
            <div className="text-center md:text-right">
              <h4 className="font-bold mb-4 text-main">معلومات قانونية</h4>
          ...
          <div className="border-t border-main pt-8 mb-8">
            <div className="glass p-5 sm:p-6 rounded-xl">
              <h4 className="font-bold mb-3 flex items-center gap-2 text-sm sm:text-base text-main">
          ...
          <div className="text-center text-subtle text-xs sm:text-sm border-t border-main pt-8">
